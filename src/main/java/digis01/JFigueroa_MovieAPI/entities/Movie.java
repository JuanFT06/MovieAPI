...
public class Movie {
   private boolean adult;
    ...
    public Movie(boolean adult, String backdrop_path, Object belongs_to_collection, int budget, ArrayList<Genre> genres, String homepage, int id, String imdb_id, String original_language, String original_name, String overview, double popularity, String poster_path, ArrayList<ProductionCompany> production_companies, String release_date, int revenue, int runtime, String status, String tagline, String title, boolean video, double vote_average, int vote_count) {
        this.adult = adult;
